...
1. Microsoft Teams を開くには、次の URL に移動します: [teams.cloud.microsoft](https://teams.cloud.microsoft)。
...
1. **[生成]** を選択し、メンバーの追加を求めるメッセージが表示されたら、**[スキップ]** を選択します。
...
1. Copilot によって、会議の出席依頼の下書きが作成されます。 提案を確認しても、**[保持]** を選択しないでください。 代わりに、次のプロンプトを入力します。

    +++ プロフェッショナルなトーンでこのメールを書き換えてください。+++

1. Copilot の提案を確認します。 結果に問題がなければ、Copilot に次のように指示します。

    +++来週の私の空き時間に基づいてこの会議をスケジュールします。+++

1. 最適な時間を選択します。 Copilot の応答の詳細に基づいて **[確認]** します。 Copilot によって、会議が予定表に追加されます。 これで、カレンダーから会議の詳細にアクセスして出席者を招待することができます。また、会議のファシリテーターをオンにしたり、競合が発生した場合に Copilot が会議のスケジュールを変更できるようにしたりすることもできます。
