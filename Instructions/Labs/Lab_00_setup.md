...
1. **Microsoft Edge** ブラウザーを開き、[[OneDrive]](https://onedrive.live.com/login/) に移動します。 指定された資格情報を入力してログインします。
...
1. アップロードが完了すると、画面の下部中央に **[マイ ファイルに 3 個のアイテムがアップロードされました]** と表示されます。
