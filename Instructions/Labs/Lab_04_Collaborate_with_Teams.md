...
1. 開始するには、この会話のためにチームのチャットに新しいチームを作成します。 [チャット] ドロップダウン メニューから **[チームを作成する]** を選択します。
...
1. Copilot に会議出席依頼の下書き作成を依頼するために、次のプロンプトを入力します。
...
1. Copilot の提案を確認します。 これで **[編集と送信]** を選択できます。
